...
/// @nodoc
@JsonSerializable()
class _$BankDataImpl extends _BankData {
  const _$BankDataImpl({this.id, this.name, this.code}) : super._();
  ...
  @override
  String toString() {
    return 'BankData(id: $id, name: $name, code: $code)';
  }
...
abstract class _BankData extends BankData {
  const factory _BankData(
      {final int? id, final String? name, final String? code}) = _$BankDataImpl;
  const _BankData._() : super._();

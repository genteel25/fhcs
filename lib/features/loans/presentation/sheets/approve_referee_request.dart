...
class ApproveRefereeRequestSheetWidget extends StatelessWidget {
  const ApproveRefereeRequestSheetWidget({super.key, required this.onApprove});
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            style:
                ElevatedButton.styleFrom(backgroundColor: AppColors.primary700),
            child: AppText(
              "Yes, Reject",
              fontSize: 14,
              fontWeight: FontWeight.w500,

...
class MembershipPaymentWidget extends StatelessWidget {
  const MembershipPaymentWidget({super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          RichText(
            text: TextSpan(
              text: "You're about to make a payment of ",
              ...
              children: [
                ...
                TextSpan(
                  text: "to complete your membership registration",
                  style: GoogleFonts.onest(
                    fontSize: 12.sp,
                    fontWeight: FontWeight.w500,
                    color: AppColors.neutral500,
          ...
          SizedBox(
            ...
            child: CustomButtonWidget(
              "I've sent the money",
              onPressed: () => AppSheets.bankTransferSuccessSheet(
                context,
                onPressed: () =>
                    context.goNamed(RouteConstants.createPasswordRoute),
              ),
            ),
          ),
          24.h.heightBox,
